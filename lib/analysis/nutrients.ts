...
export function buildNutrientProfile(
  ...
  return {
    energy_kcal: { per100g: kcal, perServing: ps(kcal), level: kcal != null ? energyLevel(kcal) : null, trafficLight: null, label: "Energy", unit: "kcal" },
    fat: { per100g: fat, perServing: ps(fat), level: ftl ? tlToLevel(ftl) : null, trafficLight: ftl, label: "Fat", unit: "g" },
    saturated_fat: { per100g: satFat, perServing: ps(satFat), level: sftl ? tlToLevel(sftl) : null, trafficLight: sftl, label: "Saturated fat", unit: "g" },
    carbohydrates: { per100g: raw.carbohydrates ?? null, perServing: ps(raw.carbohydrates ?? null), level: null, trafficLight: null, label: "Carbohydrates", unit: "g" },
    sugars: { per100g: sugars, perServing: ps(sugars), level: stl ? tlToLevel(stl) : null, trafficLight: stl, label: "Total sugars", unit: "g" },
    fibre: { per100g: fibre, perServing: ps(fibre), level: fibre != null ? fibreLevel(fibre) : null, trafficLight: null, label: "Fibre", unit: "g" },
    protein: { per100g: raw.protein ?? null, perServing: ps(raw.protein ?? null), level: null, trafficLight: null, label: "Protein", unit: "g" },
    salt: { per100g: salt, perServing: ps(salt), level: saltl ? tlToLevel(saltl) : null, trafficLight: saltl, label: "Salt", unit: "g" },
  };
}
