...
const variants: Record<Variant, string> = {
  ...
  secondary: "bg-[var(--surface-2)] text-[var(--ink)] hover:bg-[var(--hairline)]",
...
export function Button({
  ...
  return (
    <button
      {...props}
      className={cn(
        "inline-flex items-center justify-center gap-2 font-medium transition-all duration-100 disabled:opacity-40 disabled:cursor-not-allowed",
        variants[variant],
        sizes[size],
        fullWidth && "w-full",
        className
